...
### Linux & SSH Proof:
![SSH Connection & Linux Commands](1-ssh-connection.png)

### Live Website:
![Live Website - Project Completed](2-website.png)

### AWS Infrastructure:
![AMI Backup](3-ami-backup.png)
![EC2 Instance Running](4-ec2-instance.png)
![Security Group Rules](5-security-group.png)

### Linux Server Proof:
![Linux System Info & Apache Status](linux.png)
